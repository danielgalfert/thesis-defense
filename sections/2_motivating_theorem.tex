...
Classical shadow tomography is a method based on random measurements. It takes as input a set of observables and outputs its expectations over a state using $N$ samples of said state.
\\~\\
